    ...
    return (
        <a
            ...
            className={cn(
                ...
                "w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[#25D366] text-white shadow-lg",
                "transition-all duration-300 hover:scale-110 hover:shadow-xl",
                "hover:bg-[#22bf5b] focus:outline-none focus:ring-2 focus:ring-[#25D366] focus:ring-offset-2"
            )}
